...
def visualize_embeddings(embeddings, labels, epoch, loss, mode="Train"):
    ...
    plt.title(f"{mode} Embeddings - Epoch {epoch} - Loss: {loss:.4f}")
    plt.savefig(f"{mode.lower()}_embeddings_epoch_{epoch}.png")  # Save figure
